        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLordId = table.Column<int>(type: "INTEGER", nullable: true),
                    HouseCurrentLordForeignKey = table.Column<int>(type: "INTEGER", nullable: true),
                    HeirId = table.Column<int>(type: "INTEGER", nullable: true),
                    HouseHeirForeignKey = table.Column<int>(type: "INTEGER", nullable: true),
                    OverlordId = table.Column<int>(type: "INTEGER", nullable: true),
