...
namespace VictorFrye.Coldfire.Seeder.Migrations
{
    ...
    [Migration("20230301213413_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VictorFrye.Coldfire.Data.Books.BookEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VictorFrye.Coldfire.Data.Characters.CharacterEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VictorFrye.Coldfire.Data.Houses.HouseEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BookEntityCharacterEntity", b =>
                {
                    b.HasOne("VictorFrye.Coldfire.Data.Books.BookEntity", null)
                        .WithMany()
                        .HasForeignKey("BooksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VictorFrye.Coldfire.Data.Characters.CharacterEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CharacterEntityHouseEntity", b =>
                {
                    b.HasOne("VictorFrye.Coldfire.Data.Houses.HouseEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VictorFrye.Coldfire.Data.Characters.CharacterEntity", b =>
                {
                    b.HasOne("VictorFrye.Coldfire.Data.Characters.CharacterEntity", "Father")
                        .WithMany()
                        .HasForeignKey("CharacterFatherForeignKey");

                    b.HasOne("VictorFrye.Coldfire.Data.Characters.CharacterEntity", "Mother")
                        .WithMany()
                        .HasForeignKey("CharacterMotherForeignKey");

                    b.HasOne("VictorFrye.Coldfire.Data.Characters.CharacterEntity", "Spouse")
                        .WithMany()
            ...
            modelBuilder.Entity("VictorFrye.Coldfire.Data.Houses.HouseEntity", b =>
                {
                    b.HasOne("VictorFrye.Coldfire.Data.Characters.CharacterEntity", "CurrentLord")
                        .WithMany()
                        .HasForeignKey("HouseCurrentLordForeignKey");

                    b.HasOne("VictorFrye.Coldfire.Data.Characters.CharacterEntity", "Founder")
                        .WithMany()
                        .HasForeignKey("HouseFounderForeignKey");

                    b.HasOne("VictorFrye.Coldfire.Data.Characters.CharacterEntity", "Heir")
                        .WithMany()
                        .HasForeignKey("HouseHeirForeignKey");

                    b.HasOne("VictorFrye.Coldfire.Data.Houses.HouseEntity", "Overlord")
                        .WithMany()
